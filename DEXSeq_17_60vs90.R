...
samples <- samples[ which(samples$condition == "SS17_60" | samples$condition == "SS17_90"), ]
...
DEXSeqHTML(object = dxr, path="~/R_projects/ALS_RNASeq/DEXseq/SS1760vsSS1790/report",
